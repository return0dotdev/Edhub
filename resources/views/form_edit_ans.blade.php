...
<div class="container">
  ...
  <div class="row">
    <form class="form-inline border shadow-sm p-3 mb-5 bg-white rounded col-12" method="post" action="{{url('edit_ans')}}">
        {{csrf_field()}}
        <input type="hidden" name="id_ans" value="{{$row->id_ans}}" />
