...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F1C214;">
                  ...
                  @endif
                  <div id="imageheader">
                  <img src="{{asset('images/art.jpg')}}" style="width:100%;height:194px;">
                  <div>
<br/>
  <form id="form3" action="{{route('editsummernoteMessage',$post->id_post)}}" method="POST">
  {{ csrf_field() }}
    <div id="CSStheme">
      <div class="row">
        <div class="col-sm-3">
          <div class="row">
            ...
            <div class="col-9">
              <input type="text" class="form-control" name="dataheading" id="dataheading" value="{{$post->title}}"/>
            </div>
          </div>
          <br/>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-9">
              <input type="text" class="form-control" name="topic" id="topic" value="{{$post->tags}}"/>
            </div>
          </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-10">
              <div class="form-group">
                  <textarea id="summernote" name="summernote" class="from-control" >{{$post->message}}</textarea>
              </div>
            </div>
        </div>
            <div id="block-3">
