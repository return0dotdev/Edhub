                    ...
                    <div class="col-sm">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{url('profiles', $row->id_user)}}" class="btn btn-info">โปรไฟล์</a>
                            </div>
                        </div>
                    </div>
                @endforeach               
            ...
            <table class="table table-striped" style="text-align:center;">
                ...
                <tbody>
                    @php
                        $i=1
                    @endphp
                    @foreach ($popularCategory as $row)
                        <tr>
                            <th scope="row">{{$i++}}</th>
                            <td>{{$row->category}}</td>
                            <td>{{$row->count}} คำถาม</td>
                            <td><a class="btn btn-success" href="{{strtolower($row->category)}}">เข้าชม</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
