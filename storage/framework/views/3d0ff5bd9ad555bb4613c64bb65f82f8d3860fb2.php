...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F1C214;">
                  ...
                  <div id="imageheader">
                  <img src="<?php echo e(asset('images/makepost.jpg')); ?>" style="width:100%;height:300px;">
                  <div>
<br/>
  <form id="form1" action="<?php echo e(route('summernoteMessagepost')); ?>" method="POST">
   <?php echo e(csrf_field()); ?>
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="row">
            ...
            <div class="col-9">
              <input type="text" class="form-control" name="dataheading" id="dataheading" required>
            </div>
          </div>
          <br/>
          <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-10">
              <div class="form-group">
                      <textarea id="summernote" name="summernote" class="from-control" required></textarea>
              </div>
            </div>
          </div>
            <div id="block-3">
                <input type="submit" name="send" id="send" class="btn btn-warning" value="ตั้งกระทู้" >
...
</html><?php /**PATH C:\xampp\htdocs\Edhub\resources\views/post.blade.php ENDPATH**/ ?>