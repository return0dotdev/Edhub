...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F1C214;">
                  ...
                  <?php if(session('alert')): ?>
                    ...
                    <?php Session::flush(); ?>
                  <?php endif; ?>
<?php $__currentLoopData = $show_ans_view; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<br />
<div class="container">
  ...
  <div class="row">
    <form class="form-inline border shadow-sm p-3 mb-5 bg-white rounded col-12" method="post" action="<?php echo e(url('edit_ans')); ?>">
        <?php echo e(csrf_field()); ?>

        <input type="hidden" name="id_ans" value="<?php echo e($row->id_ans); ?>" />
        <input type="hidden" name="id_post" value="<?php echo e($row->id_post); ?>" />
        <textarea id="summernote" name="summernote" class="from-control"> 
...
</html><?php /**PATH C:\xampp\htdocs\Edhub\resources\views/form_edit_ans.blade.php ENDPATH**/ ?>