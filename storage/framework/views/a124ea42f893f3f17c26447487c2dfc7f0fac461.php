...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F1C214;">
	...
	<div class="d-flex justify-content-around">		
		...
		<div class="card-body">
		<h1 class="text-black-50" align="center">สมัครสมาชิก</h1>
		<form class="form-group" id="register" method="post" action="<?php echo e(route('register1')); ?>" >	
    <?php echo e(csrf_field()); ?>

        <input type="text" name="firstname" placeholder="ชื่อ"  class="form-control" required><br>
        <input type="text" name="lastname" placeholder="นามสกุล"  class="form-control" required><br>
        <input type="text" name="jobs" placeholder="อาชีพ"  class="form-control" required><br>
        <input type="number" name="tel" placeholder="เบอร์โทรศัพท์"  class="form-control" required><br>
        <input type="email" name="email" placeholder="อีเมล"  class="form-control" required><br>
        <input type="password" name="password" id="password" placeholder="รหัสผ่าน"  class="form-control" required><br>
        <input type="password" name="password_con" id="confirm_password" placeholder="ยืนยันรหัสผ่าน"  class="form-control" required><br>
        <label class="radio-inline">
        <input type="radio" name="user_type" value="student">นักศึกษา/บุคลากรทั่วไป<br>
        </label>
        <label class="radio-inline">
        <input type="radio" name="user_type" value="teacher">อาจารย์/ผู้ให้ความรู้<br>
        </label>
        <br>
          <center><input type="submit" value="สมัครสมาชิก" class="btn btn-dark" ></center>
		</form></div></div></div>
		</div>			
		<br>
...
</script><?php /**PATH C:\xampp\htdocs\Edhub\resources\views/Register.blade.php ENDPATH**/ ?>