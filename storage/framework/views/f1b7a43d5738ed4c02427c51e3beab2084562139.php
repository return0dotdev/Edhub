...
<form class="form-horizontal" method="POST" action="<?php echo e(url('edit_profiles')); ?>" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
    ...
    <div class="form-group row">
      ...
      <div class="form-group row">
        <div class="col-md-2">
          <img src="<?php echo e(asset('images/'.$row->img)); ?>" alt="Avatar" class="img" style="width:150px; height:150px;" id="imgPreview" >
        </div>
        <div class="col-md-auto">
          <p>
            <h3><?php echo e($row->firstname); ?> <?php echo e($row->lastname); ?></h3>
            <br>
...
<?php endif; ?>
            <input type="hidden" name="phodo" value="<?php echo e($row->img); ?>">
...
<br>
      <div class="form-group row">
        ...
        <div class="col-md-4">
        <input type="text" name="firstname" class="form-control" id="firstname" value="<?php echo e($row->firstname); ?>" placeholder="Enter Firstname">
        </div>
        ...
        <div class="col-md-4">
          <input type="text" name="email" class="form-control" id="email" value="<?php echo e($row->email); ?>" placeholder="example@laraval.com">
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
          <input type="text" name="lastname" class="form-control" id="lastname" value="<?php echo e($row->lastname); ?>" placeholder="Enter Lastname">
        </div>
        ...
        <div class="col-md-4">
          <input type="text" name="password" class="form-control" id="password" value="<?php echo e($row->password); ?>" placeholder="Enter Password">
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
          <input type="text" name="job" class="form-control" id="job" value="<?php echo e($row->jobs); ?>" placeholder="Enter your job">
        </div>
        ...
        <div class="col-md-4">
          <input type="text" name="tel" class="form-control" id="tel" value="<?php echo e($row->tel); ?>" placeholder="Ex. 0909009090">
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
            <textarea class="form-control" name="bio" id="bio" rows="4" placeholder="Write something about you <optional>"><?php echo e($row->bio); ?></textarea>
        </div>
        ...
        <div class="col-md-4">
          <textarea class="form-control" name="web" id="website" rows="4" placeholder="Ex. www.helloworld.com"><?php echo e($row->website); ?></textarea>
        </div>
      </div>
...
<?php /**PATH C:\xampp\htdocs\Edhub\resources\views/edit_profile.blade.php ENDPATH**/ ?>