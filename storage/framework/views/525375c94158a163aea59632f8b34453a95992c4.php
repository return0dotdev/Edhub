...
<?php $__env->startSection('content'); ?>
    <br>
    <img src="images/general.jpg" width="100%" height="300">
    <br><br><br>

    <!-- กระทู้ยอดนิยม -->
    <b><h4 style="float:left">กระทู้ยอดนิยม</h4></b>
    <b><a class="btn btn-warning text-white" href="general/allpost" style="float:right;"><u>กระทู้ทั้งหมด</u></a></b>
    <br><br>
    ...
    <b><a class="btn btn-warning text-white" href="general/allblog" style="float:right;"><u>บทความทั้งหมด</u></a></b>
    <br><br>
    <table class="table table-bordered">
        <tbody>
...
<?php echo $__env->make('layouts/Edhub-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Edhub\resources\views/general.blade.php ENDPATH**/ ?>