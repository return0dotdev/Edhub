                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                          <a class="nav-link" href="<?php echo e(url('admin1')); ?>"><b>ผู้ใช้ที่ถูกรายงาน</b><span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
                          <a class="nav-link" href="<?php echo e(url('admin2')); ?>" ><font color="white"><b>อนุมัติอาจารย์</b></font></a>
                        </li>
                      </ul>
...
<table border="1" width="100%" align="center" class="table-dark">
    ...
    <tr>       
        ...
        <td align="center" ><img src="<?php echo e(asset('/images/' .$row->img )); ?>" height="100" width="150"></td>
            <td align="center"><a onclick="return JSalert()" class="btn btn-success"  href="<?php echo e(url('approve', $row->id_user)); ?>">อนุมัติ</a>
            <a onclick="return JSalert2()" class="btn btn-danger"  href="<?php echo e(url('noapprove', $row->id_user)); ?>">ไม่อนุมัติ</a></td> 
    </tr>
