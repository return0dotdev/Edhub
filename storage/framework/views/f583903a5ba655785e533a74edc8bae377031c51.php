...
<table border="0" width="1200" align="center">
    <tr>
        <td align="left" ><h1>ผู้ใช้ที่ถูกรายงาน</h1></td>
    </tr>
</table>
</div>
<div>
<table border="1" width="100%" align="center" class="table-dark">
    ...
    <tr>
        ...
        <td align="center" >จำนวนที่ถูกรายงาน</td>
        <td align="center" ></td>
        <td align="center" ></td>
    </tr>
    ...
    <?php $__currentLoopData = $admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($row->c_report >= 40): ?>
        <tr>       
            <td align="center" ><?php echo e($row->title); ?></td>
            <td align="center" ><?php echo e($row->type); ?></td>
            <td align="center" ><?php echo e($row->category); ?></td>
            <td align="center" ><?php echo e($row->c_report); ?></td>
            <?php if( $row->status != 0): ?>
                <td align="center"><a onclick="return JSalert()" class="btn btn-danger"  href="<?php echo e(url('banupdate', $row->id_post)); ?>">ระงับการเผยแพร่</a></td>          
            <?php else: ?>
                <td align="center"><a onclick="return JSalert2()" class="btn btn-success"  href="<?php echo e(url('rebanupdate', $row->id_post)); ?>">เปิดการเผยแพร่</a></td>          
            <?php endif; ?>
            <td align="center" ><a class="btn btn-success"  href="<?php echo e(url('post', $row->id_post)); ?>" target="_blank">รายละเอียด</td>
...
<script type="text/javascript">
    function JSalert(){
           var chk = confirm("คุณต้องการจะระงับการเผยแพร่ใช่หรือไม่");
               if (chk == true)
				   return(true);
               else
				   return(false);    
    ...
    function JSalert2(){
        var chk=0;
			   chk = confirm("คุณต้องการจะปลดการระงับการเผยแพร่ใช่หรือไม่");
               if (chk == true)
				   return(true);
               else
				   return(false);
...
<?php /**PATH C:\xampp\htdocs\Edhub\resources\views/admin1.blade.php ENDPATH**/ ?>