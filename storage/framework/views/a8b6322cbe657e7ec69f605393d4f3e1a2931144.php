...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F1C214;">
        ...
        <div class="container">
            ...
            <!-- กระทู้ทั้งหมด -->
            <b><h4 style="float:left">กระทู้ทั้งหมด</h4></b>
            <br><br>
            <table class="table table-bordered">
                <tbody>
                <?php $__currentLoopData = $showAllPost; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\Edhub\resources\views/generalAllPost.blade.php ENDPATH**/ ?>