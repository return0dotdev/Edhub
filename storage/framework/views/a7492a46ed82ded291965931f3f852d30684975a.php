...
<?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="container">
            ...
            <div class="profile">
                ...
                <img src="<?php echo e(asset('images/'.$row->img)); ?>"  style="width: 200px; height: 200px;">

                </div>

                <div class="profile-user-settings ">

                <h1 class="profile-user-name"><?php echo e($row->firstname); ?> <?php echo e($row->lastname); ?></h1>

                <?php if(Session::get('id_user') == $row->id_user || (Session::get('id_user') == null && Session::get('id_user') == $row->id_user)): ?>

                <a href="<?php echo e(url('/edit_profile/'.$row->id_user)); ?>"><button class="btnp profile-edit-btn">Edit Profile</button></a>
                    <button class="btnp profile-settings-btn" aria-label="profile settings"><i class="fas fa-cog" aria-hidden="true"></i></button>
                 <?php endif; ?>
                </div>

                <div class="profile-bio">
                    <p><span class="profile-real-name">Job: </span><?php echo e($row->jobs); ?></p>
                    <p><span class="profile-real-name">Tel: </span><?php echo e($row->tel); ?></p>
                    <p><span class="profile-real-name">Email: </span><?php echo e($row->email); ?></p>
                    <p><span class="profile-real-name">Bio: </span><?php echo e($row->bio); ?></p>
                    <p><span class="profile-real-name"><a href="<?php echo e($row->website); ?>"><?php echo e($row->website); ?></a></span></p>
    ...
    <main>
        <div class="container">
            <div class="w3-bar w3-light">
                <button class="w3-bar-item w3-button tablink btn-outline-warning" onclick="openLink(event,'Post');"><h3>กระทู้</h3></button>
                <button class="w3-bar-item w3-button tablink btn-outline-warning" onclick="openLink(event,'Article');"><h3>บทความ</h3></button>
            </div>
...
<table class="table table-bordered">
    <tbody>
            <?php $__currentLoopData = $get_type_posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr onclick="document.location = '<?php echo e(url('post', $row->id_post)); ?>';" onmouseover="this.style.backgroundColor='#FFCC00'; this.style.cursor='pointer';" onmouseout="this.style.backgroundColor='white';">
                            <td scope="row">
                                ...
                                <div class="float-left">
                                    <?php echo e($row->category.' '.date('H:i d/m/Y', strtotime($row->date_time_post))); ?>
        ...
        <div id="Article" class="row myLink">
            <table class="table table-bordered">
                <tbody>
            <?php $__currentLoopData = $get_type_articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr onclick="document.location = '<?php echo e(url('article', $row->id_post)); ?>';" onmouseover="this.style.backgroundColor='#FFCC00'; this.style.cursor='pointer';" onmouseout="this.style.backgroundColor='white';">
                    <td scope="row">
                        <h5><?php echo e($row->title); ?></h5>
                        <div class="float-left">
                            <?php echo e($row->category.' '.date('H:i d/m/Y', strtotime($row->date_time_post))); ?>
...
<?php /**PATH C:\xampp\htdocs\Edhub\resources\views/profile.blade.php ENDPATH**/ ?>