...
<html>
    <head>
      ...
      <style>
        ...
        <title>Edit Post and artical</title>
  </head>
  <body>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #F1C214;">
                  ...
                  <?php endif; ?>
                  <div id="imageheader">
                  <img src="<?php echo e(asset('images/art.jpg')); ?>" style="width:100%;height:194px;">
                  <div>
<br/>
  <form id="form3" action="<?php echo e(route('editsummernoteMessage',$post->id_post)); ?>" method="POST">
  <?php echo e(csrf_field()); ?>
    ...
    <div id="CSStheme">
      <div class="row">
        <div class="col-sm-3">
          <div class="row">
            <div class="col-3">
                <label for="exampleInputEmail1">หัวเรื่อง</label>
            </div>
            <div class="col-9">
              <input type="text" class="form-control" name="dataheading" id="dataheading" value="<?php echo e($post->title); ?>"/>
            </div>
          </div>
          <br/>
          <div class="row">
            ...
            <div class="col-9">
            <!-- value="<?php echo e($post->type); ?>" -->
            <select class="form-control" name="selectcategory" id="selectcategory" >
                <option <?php if($post->type=="General"){echo"selected";} ?>>General</option>
                <option <?php if($post->type=="Mathematics"){echo"selected";} ?>>General</option>
                <option <?php if($post->type=="Science"){echo"selected";} ?>>Science</option>
                <option <?php if($post->type=="Language"){echo"selected";} ?>>Language</option>
                <option <?php if($post->type=="Social"){echo"selected";} ?>>Social</option>
                <option <?php if($post->type=="Arts"){echo"selected";} ?>>Arts</option>
          ...
          <div class="row">
            ...
            <div class="col-9">
              <input type="text" class="form-control" name="topic" id="topic" value="<?php echo e($post->tags); ?>"/>
            </div>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-1">
                <label for="exampleInputEmail1"><h4>เนื้อหา</h4></label>
            </div>
            <div class="col-10">
              <div class="form-group">
                  <textarea id="summernote" name="summernote" class="from-control" ><?php echo e($post->message); ?></textarea>
              </div>
            </div>
        </div>
            <div id="block-3">
                <input type="submit" name="send" id="send" class="btn btn-warning" value="แก้ไข" >
                <input type="button" name="clear" id="clear" class="btn btn-dark" value="ล้าง" >
            </div>
      </div>
    </div>
  </form>
  ...
  <script type="text/javascript">
        ...
        $('#clear').on('click',function(){
          // if(confirm("Want to clear?")){
            ...
            // $('#selectcategory')[0].options.reset;
            // $('#selectcategory').find('option:not(:first)').remove();
            // document.getElementById("selectcategory").options.length = 5;
					// }	
        })
...
</html><?php /**PATH C:\xampp\htdocs\Edhub\resources\views/edit.blade.php ENDPATH**/ ?>